...
namespace FOX.BusinessOperations.SurveyAutomationService
{
    public interface ISurveyAutomationService
    {
        ...
        ResponseModel SendPatientSurveyLink(PatientSurvey objPatientSurvey, UserProfile profile);
        ResponseModel SubscribleUnsubscribleSurvey(PatientSurvey objPatientSurvey, UserProfile profile);
