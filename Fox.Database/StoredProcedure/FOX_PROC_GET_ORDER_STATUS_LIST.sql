IF (OBJECT_ID('FOX_PROC_GET_ORDER_STATUS_LIST') IS NOT NULL ) DROP PROCEDURE FOX_PROC_GET_ORDER_STATUS_LIST  
GO   
----3   
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
--exec [FOX_PROC_GET_ORDER_STATUS_LIST] '1011163','','','',1,0,'CreatedDate','DESC'                 
CREATE procedure [dbo].[FOX_PROC_GET_ORDER_STATUS_LIST]-- 1011163,'','al001',1, 2000, 'code' , 'desc'                                            
...
AS  
     BEGIN  
       ...
       IF(@NAME = '')  
         ...
         --          
         SELECT @TOATL_PAGESUDM = COUNT(DISTINCT l.ORDER_STATUS_ID)  
         FROM FOX_TBL_ORDER_STATUS l  
