IF (OBJECT_ID('FOX_PROC_GET_PSR_USER_NAME_LIST') IS NOT NULL ) DROP PROCEDURE FOX_PROC_GET_PSR_USER_NAME_LIST  
GO
-- =============================================  
...
--[DBO].[FOX_PROC_GET_PSR_USER_NAME_LIST] 1011163  
  
CREATE PROCEDURE [DBO].[FOX_PROC_GET_PSR_USER_NAME_LIST] --1011163, ''  
 (  
