IF (OBJECT_ID('FOX_PROC_GET_SUPERVISORS_FOR_DROPDOWN') IS NOT NULL ) DROP PROCEDURE FOX_PROC_GET_SUPERVISORS_FOR_DROPDOWN  
GO         
CREATE Procedure [dbo].[FOX_PROC_GET_SUPERVISORS_FOR_DROPDOWN] --1011163            
(            
