IF (OBJECT_ID('FOX_PROC_GET_PSR_PROVIDER_AND_RECOMMENDATION_WISE') IS NOT NULL ) DROP PROCEDURE FOX_PROC_GET_PSR_PROVIDER_AND_RECOMMENDATION_WISE  
GO     
-- =============================================            
-- AUTHOR:  <DEVELOPER, YOUSAF>            
-- CREATE DATE: <CREATE DATE, 05/02/2018>            
-- DESCRIPTION: <GET PATIENT SURVEY REPORT; PROVIDER AND RECOMMENDATION WISE>            
            
--    [DBO].[FOX_PROC_GET_PSR_PROVIDER_AND_RECOMMENDATION_WISE] 1011163, 'NY6 NY Queens', NULL, NULL, '', '','','',0, 0, ''             
CREATE PROCEDURE [DBO].[FOX_PROC_GET_PSR_PROVIDER_AND_RECOMMENDATION_WISE] -- 1011163, 'NY6 NY Queens', NULL, NULL, '', '','','',0, 0, ''            
 (            
...
BEGIN            
 ...
 SELECT PROVIDER            
  ...
  ,SUM(CASE             
    ...
    ELSE 0            
    END) NOT_RECOMMENDED            
  ,CONVERT(INT, ROUND(CONVERT(DECIMAL(5, 2), 100 * CONVERT(DECIMAL, (            
       SUM(CASE             
         WHEN IS_REFERABLE = 1            
          THEN 1            
         ELSE 0            
