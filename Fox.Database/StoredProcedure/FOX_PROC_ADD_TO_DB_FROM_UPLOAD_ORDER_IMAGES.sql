IF (OBJECT_ID('FOX_PROC_ADD_TO_DB_FROM_UPLOAD_ORDER_IMAGES') IS NOT NULL ) DROP PROCEDURE FOX_PROC_ADD_TO_DB_FROM_UPLOAD_ORDER_IMAGES
GO 
  -- =============================================                    
-- Author:  <Author,Abdur Rafey>                    
-- Create date: <Create Date,01/11/2021>                    
-- DESCRIPTION: <ADD_TO_DB_FROM_UPLOAD_ORDER_IMAGES>         
CREATE PROCEDURE FOX_PROC_ADD_TO_DB_FROM_UPLOAD_ORDER_IMAGES(    
