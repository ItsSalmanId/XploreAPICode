IF (OBJECT_ID('FOX_PROC_GET_LOCATION_CORPORATION_LIST') IS NOT NULL ) DROP PROCEDURE FOX_PROC_GET_LOCATION_CORPORATION_LIST  
GO    
----10   
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- 
-- =============================================                                                    
...
-- DESCRIPTION: <GET LOCATION CORPORATION LIST>      
--exec FOX_PROC_GET_LOCATION_CORPORATION_LIST '9090992','','','',1,10,'Code','DESC'                 
CREATE procedure [FOX_PROC_GET_LOCATION_CORPORATION_LIST]-- 1011163,'','al001',1, 2000, 'code' , 'desc'                                            
...
AS  
     BEGIN  
       ...
       IF(@NAME = '')  
         ...
         --          
         SELECT @TOATL_PAGESUDM = COUNT(DISTINCT l.LOCATION_CORPORATION_ID)  
         FROM FOX_TBL_LOCATION_CORPORATION l  
