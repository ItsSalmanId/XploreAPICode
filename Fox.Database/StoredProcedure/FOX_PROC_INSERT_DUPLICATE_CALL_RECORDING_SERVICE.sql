IF (OBJECT_ID('FOX_PROC_INSERT_DUPLICATE_CALL_RECORDING_SERVICE') IS NOT NULL ) DROP PROCEDURE FOX_PROC_INSERT_DUPLICATE_CALL_RECORDING_SERVICE  
GO   
-- =============================================      
...
-- EXEC FOX_PROC_INSERT_DUPLICATE_CALL_RECORDING_SERVICE 544101, 1011163,'10/22/2019 6:17:25 PM','10/22/2019 3:17:09 AM','10/22/2019 3:17:09 AM','8795468795','Shery',1,'MTBC','1235','ps_1011163_112233445_1530963927631'      
      
CREATE PROCEDURE FOX_PROC_INSERT_DUPLICATE_CALL_RECORDING_SERVICE    
