IF (OBJECT_ID('FOX_PROC_GET_DM_CONFIGURATION') IS NOT NULL ) DROP PROCEDURE FOX_PROC_GET_DM_CONFIGURATION 
GO      
CREATE PROCEDURE [dbo].[FOX_PROC_GET_DM_CONFIGURATION]        
AS        
     BEGIN        
    ...
    isnull(IS_DIRECT_MAIL,0) IS_DIRECT_MAIL      
