IF (OBJECT_ID('FOX_PROC_GET_CITY_STATE_COUNTY_REGION_BY_COUNTY_NEW') IS NOT NULL ) DROP PROCEDURE FOX_PROC_GET_CITY_STATE_COUNTY_REGION_BY_COUNTY_NEW  
GO   
-- 03  
...
-- DESCRIPTION: <FOX PROC GET CITY STATE COUNTY REGION BY COUNTY NEW>  
  
CREATE PROCEDURE [dbo].[FOX_PROC_GET_CITY_STATE_COUNTY_REGION_BY_COUNTY_NEW] --'Adams',1011163        
@COUNTY VARCHAR(20),     
