...
-- Description: <Description, Insert Task details>       
-- [dbo].[FOX_PROC_INSERT_CONSENT_TO_CARE_TASK] 1012714, '', '','','','','','','','''','','', 1012714                        
-- =============================================                                     
CREATE PROCEDURE FOX_PROC_INSERT_CONSENT_TO_CARE_TASK           
 @ID BIGINT,            
...
-- select * from FOX_TBL_TASK where TASK_ID = @ID                    
 INSERT INTO FOX_TBL_TASK (                    
  ...
  SELECT * FROM FOX_TBL_TASK WITH(NOLOCK) WHERE TASK_ID = @ID                    
END     