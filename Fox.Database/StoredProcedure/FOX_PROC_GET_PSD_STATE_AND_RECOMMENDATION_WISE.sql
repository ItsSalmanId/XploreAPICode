IF (OBJECT_ID('FOX_PROC_GET_PSD_STATE_AND_RECOMMENDATION_WISE') IS NOT NULL ) DROP PROCEDURE FOX_PROC_GET_PSD_STATE_AND_RECOMMENDATION_WISE  
GO       
-- =============================================          
...
--  [DBO].[FOX_PROC_GET_PSD_STATE_AND_RECOMMENDATION_WISE] 1011163, null, null, '', '','',''          
          
CREATE  PROCEDURE [DBO].[FOX_PROC_GET_PSD_STATE_AND_RECOMMENDATION_WISE] --1011163, null, null, '', ''          
 (          
