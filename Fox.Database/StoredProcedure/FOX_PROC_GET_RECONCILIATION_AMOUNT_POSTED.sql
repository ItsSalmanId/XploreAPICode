IF (OBJECT_ID('FOX_PROC_GET_RECONCILIATION_AMOUNT_POSTED') IS NOT NULL ) DROP PROCEDURE FOX_PROC_GET_RECONCILIATION_AMOUNT_POSTED  
GO        
 -- FOX_PROC_GET_RECONCILIATION_AMOUNT_POSTED_TEST  1012714, 1, 0, '11/23/2020','11/23/2020'           
CREATE PROCEDURE [dbo].[FOX_PROC_GET_RECONCILIATION_AMOUNT_POSTED]      
(      
     ...
     END;                                        
      ...
      BEGIN                              
             ...
             BEGIN                                        
                 SET @DATE_TO = @DATE_TO+'%';                                        
             END      
         SELECT  distinct ftrc.AMOUNT_POSTED AS [Value], Convert(varchar(25),ftrc.AMOUNT_POSTED) as StringValue            
         FROM dbo.FOX_TBL_RECONCILIATION_CP ftrc            
         WHERE ftrc.AMOUNT_POSTED is not null            
