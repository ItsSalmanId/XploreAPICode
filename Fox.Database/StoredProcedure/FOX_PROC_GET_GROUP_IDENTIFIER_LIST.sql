IF (OBJECT_ID('FOX_PROC_GET_GROUP_IDENTIFIER_LIST') IS NOT NULL ) DROP PROCEDURE FOX_PROC_GET_GROUP_IDENTIFIER_LIST 
GO  
----9   
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    -- =============================================                                                    
...
-- DESCRIPTION: <GET GROUP IDENTIFIER LIST>  
     
--exec FOX_PROC_GET_GROUP_IDENTIFIER_LIST '9090992','','','',1,0,'CreatedDate','DESC'                 
CREATE procedure [dbo].[FOX_PROC_GET_GROUP_IDENTIFIER_LIST]-- 1011163,'','al001',1, 2000, 'code' , 'desc'                                            
...
AS  
     BEGIN  
       ...
       IF(@NAME = '')  
         ...
         --          
         SELECT @TOATL_PAGESUDM = COUNT(DISTINCT l.GROUP_IDENTIFIER_ID)  
         FROM FOX_TBL_GROUP_IDENTIFIER l  
