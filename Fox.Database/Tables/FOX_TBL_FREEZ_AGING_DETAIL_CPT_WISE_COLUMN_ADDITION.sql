...
/****** Object:  Table [dbo].[FOX_TBL_FREEZ_AGING_DETAIL_CPT_WISE_COLUMN_ADDITION]    Script Date: 7/21/2022 8:57:56 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[FOX_TBL_FREEZ_AGING_DETAIL_CPT_WISE_COLUMN_ADDITION](
	...
	[ADJUSTMENT_CODE] [varchar](500) NULL,
	[ADJUSTMENT_DESCRIPTION] [varchar](5000) NULL,
	[REMARK_CODE] [varchar](500) NULL,
	[REMARK_DESCRIPTION] [varchar](5000) NULL,
	[DENIAL_DATE] [varchar](50) NULL,
	[INSPAYER_DESCRIPTION] [varchar](500) NULL,
