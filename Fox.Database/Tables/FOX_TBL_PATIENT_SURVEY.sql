...
/****** Object:  Table [dbo].[FOX_TBL_PATIENT_SURVEY]    Script Date: 7/21/2022 9:20:11 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[FOX_TBL_PATIENT_SURVEY](
	...
	[CREATED_BY] [varchar](70) NOT NULL CONSTRAINT [DF_FOX_TBL_PATIENT_SURVEY_CREATED_BY]  DEFAULT ('FOX TEAM'),
	[CREATED_DATE] [datetime] NULL,
	[MODIFIED_BY] [varchar](70) NOT NULL CONSTRAINT [DF_FOX_TBL_PATIENT_SURVEY_MODIFIED_BY]  DEFAULT ('FOX TEAM'),
	[MODIFIED_DATE] [datetime] NULL,
	[IS_SURVEYED] [bit] NOT NULL,
	[FILE_NAME] [varchar](200) NULL,
	[SHEET_NAME] [varchar](200) NULL,
	[TOTAL_RECORD_IN_FILE] [bigint] NULL,
	[DELETED] [bit] NOT NULL CONSTRAINT [DF_FOX_TBL_PATIENT_SURVEY_DELETED]  DEFAULT ((0)),
	...
	[rowguid] [uniqueidentifier] ROWGUIDCOL  NOT NULL CONSTRAINT [MSmerge_df_rowguid_9D74A018C7124E63962079859FC708ED]  DEFAULT (newsequentialid()),
	[IS_EXCEPTIONAL] [bit] NULL,
	[IS_PROTECTIVE_EQUIPMENT] [bit] NULL,
	[Survey_Completed_Date] [datetime] NULL,
 CONSTRAINT [PK_FOX_TBL_PATIENT_SURVEY] PRIMARY KEY CLUSTERED 
(
	[SURVEY_ID] ASC
